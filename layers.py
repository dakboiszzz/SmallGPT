...
class MultiHead(nn.Module):
    def __init__(self,num_heads, head_size, n_emb, block_size):
        super().__init__()
        self.heads = nn.ModuleList([Head(head_size,n_emb,block_size) for _ in range(num_heads)])
...
class Block(nn.Module):
    # Transformer Block
    def __init__(self,num_heads, n_emb, block_size):
        super().__init__()
        head_size = n_emb//num_heads
        self.sa = MultiHead(num_heads, head_size, n_emb, block_size)
